...
compact-reviewer/scripts/lint-compact.sh <file>

# Disclosure validation (privacy leaks)
python3 compact-reviewer/scripts/check-disclosure.py <file>

# Compilation check (if compactc available)
compact-reviewer/scripts/verify-compilation.sh <file> --skip-zk

# Complexity analysis (constraint estimation)
python3 compact-reviewer/scripts/analyze-complexity.py <file>
```
...
**Reviewed**: {timestamp}
**Scope**: {scope}
**Version**: compact-reviewer v1.0.0
...
*Generated by compact-reviewer v1.0.0*
```
